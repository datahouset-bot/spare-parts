...
<div class="col-md-6">
  <form action="{{ route('primarygroups.update', $primarygroup->id) }}" method="POST">
    @csrf
    @method('PUT')
    <div>

    Primary Unit Name   <input type="text" name ="primary_group_name"class="form-control" placeholder="Primary group  " value="{{ old('primary_group_name', $primarygroup->primary_group_name) }}">
