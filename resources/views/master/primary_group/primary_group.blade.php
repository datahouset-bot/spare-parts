                    ...
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                          <form action="{{url('/primarygroups')}}" method="POST">
                           ...
                           Primary Group Name    <input type="text" name ="primary_group_name"class="form-control" placeholder="Primary Group Name ">
            ...
            <table class="table table-striped" id="remindtable">
                ...
                <tbody>
                  ...
                  <tr>
                    ...
                    <td>
                      <a href="{{ route('primarygroups.edit', $record['id']) }}" class="btn  btn-sm" ><i class="fa fa-edit" style="font-size:20px;color:SlateBlue"></i></a>
