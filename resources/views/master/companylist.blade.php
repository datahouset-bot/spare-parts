            ...
            <table class="table table-striped " id="remindtable">
                ...
                <tbody>
                  ...
                  <tr>
                    ...
                    <td><a href="{{('showeditecompany/'.$record['id']) }}"  ><i class="fa fa-edit" style="font-size:20px;color:SlateBlue"></i></a></td>
                    <td><a href="{{('deletecompany/'.$record['id']) }}" ><i class="fa fa-trash" style="font-size:20px;color:OrangeRed"></i></a></td>
                  </tr>
                  @endforeach
