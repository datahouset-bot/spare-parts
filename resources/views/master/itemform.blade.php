                                    ...
                                    <div class="card-body">
                                        <form action="{{url('/saveitem')}}" method="POST">
                                            ...
                                            <div class="row mb-3">
                                                ...
                                                <div class="col-md-4">
                                                  <div class="form-floating mb-3 mb-md-0">
                                                      <input class="form-control" id="item_barcode" type="text" name="item_barcode" value="{{ old('item_barcode') }}" />
                                                    <span class="text-danger"> 
                                                      @error('item_barcode')
                                                      {{$message}}
                                                ...
                                                <div class="col-md-2 mt-2">
                                                  <div class="form-floating mb-3 mb-md-0">
                                                      <input class="form-control" id="sale_rate_a" type="text" name="sale_rate_a" value="{{ old('sale_rate_a') }}" />
                                                    <span class="text-danger"> 
                                                      @error('sale_rate_a')
                                                      {{$message}}
                                                ...
                                                <div class="col-md-2 mt-2">
                                                  <div class="form-floating mb-3 mb-md-0">
                                                      <input class="form-control" id="sale_rate_b" type="text" name="sale_rate_b" value="{{ old('sale_rate_b') }}" />
                                                    <span class="text-danger"> 
                                                      @error('sale_rate_b')
                                                      {{$message}}
                                              ...
                                              <div class="col-md-2 mt-2">
                                                <div class="form-floating mb-3 mb-md-0">
                                                    <input class="form-control" id="sale_rate_c" type="text" name="sale_rate_c" value="{{ old('sale_rate_c') }}" />
                                                  <span class="text-danger"> 
                                                    @error('sale_rate_c')
                                                    {{$message}}
                                            ...
                                            <div class="col-md-2 mt-2">
                                              <div class="form-floating mb-3 mb-md-0">
                                                  <input class="form-control" id="purchase_rate" type="text" name="purchase_rate" value="{{ old('purchase_rate') }}" />
                                                <span class="text-danger"> 
                                                  @error('purchase_rate')
                                                  {{$message}}
