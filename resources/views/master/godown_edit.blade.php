...
<div class="col-md-6">
  <form action="{{ route('godowns.update', $godown->id) }}" method="POST">
   ...
   Godown Name   <input type="text" name ="godown_name"class="form-control" placeholder="godown " value="{{ old('godown_name', $godown->godown_name) }}">
  ...
  <div>
    ...
    Godown Address   <input type="text" name ="godown_address"class="form-control" value="{{ old('godown_address', $godown->godown_address) }}">
    <span class="text-danger"> 
