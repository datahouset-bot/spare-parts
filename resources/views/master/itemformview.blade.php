                                        ...
                                        <form action="">
                                            ...
                                            <div class="row mb-3">
                                                ...
                                                <div class="col-md-6 mt-2">
                                                    <div class="form-floating mb-3 mb-md-0">
                                                        <input class="form-control" id="company" type="text" name="company" value="{{ $data->company->comp_name }}" />
                                                      <span class="text-danger"> 
                                                        @error('company')
                                                        {{$message}}
                                                ...
                                                <div class="col-md-6 mt-2">
                                                    <div class="form-floating mb-3 mb-md-0">
                                                        <input class="form-control" id="group" type="text" name="group" value="{{ $data->item_group }}" />
                                                      <span class="text-danger"> 
                                                        @error('group')
                                                        {{$message}}
                                                ...
                                                <div class="col-md-4 mt-2">
                                                    <div class="form-floating mb-3 mb-md-0">
                                                        <input class="form-control" id="unit" type="text" name="unit" value="{{ $data->unit->primary_unit_name }}" />
                                                      <span class="text-danger"> 
                                                        @error('unit')
                                                        {{$message}}
