        ...
        <div class="container-fluid my-1">
            ...
            <div class="row justify-content-center align-items-center">
                ...
                <div class="container mt-1">
                    <form action="{{ url('outstanding_receivable_result') }}" method="POST">
                        @csrf

                        <div class="row "id="account_select_form">
                            <div class="col-md-3 mb-3">
                                <h5> Outstanding Receivable</h5>
                            </div>
                    ...
                    <table class ="table table-responsive table-striped ">
                        ...
                        <tbody>
                            @php
                                $totalbalance = 0;
                            @endphp
                            @foreach ($outstandingReceivables as $record)
                                <tr>
                                    ...
                                    @php
                                        ...
                                        if ($record->balnce_type === 'Dr') {
                                            $balance =
                                                $record->op_balnce + $record->total_debit - $record->total_credit;
                                        } else {
                                            $balance =
                                                $record->total_debit - $record->op_balnce - $record->total_credit;
                                        }
                                    ...
                                    <td>
                                        <form action="{{ url('ledger_show') }}" method="POST">
                                            ...
                                            <input type="hidden" name="account_id"
                                                value="                               {{ $record->id }}">
                                            <input type="hidden" class="form-control " name="from_date" value="01-04-2019"
                                                required>
                                            <input type="hidden" class="form-control date" name="to_date"
