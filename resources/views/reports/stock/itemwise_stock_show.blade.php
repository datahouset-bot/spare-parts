        ...
        <div class="container-fluid my-1">
            ...
            <div class="row justify-content-center align-items-center form-group">
                ...
                <div class="container mt-5" id="account_select_form">
                    <form action="{{ url('item_wise_stock') }}" method="POST">
                        @csrf
                        <div class="row">
                ...
                <h5> Stock Ledger for Item : {{ $item_name->item_name }} &nbsp; From Date-&nbsp;{{ $from_date }} To
                    Date-&nbsp;{{ $to_date }}</h5>
                    ...
                    <table class ="table table-striped " id="remindtable">
                        ...
                        <tbody>
                            @php
                                ...
                                $opening_balanceDisplay =  ($final_opning_balance >= 0 ? ' ' : ' -').abs($final_opning_balance) ;
                            ...
                            <tr>
                                <td scope="col">{{ \Carbon\Carbon::parse($record->entry_date)->format('d-m-y') }}</td>
                                ...
                                @php
                                    ...
                                    $currentBalance = $record->stock_in - $record->stock_out;
                                    // Update the running balance
                                    $debitBalance += $record->stock_in;
                                    $creditBalance += $record->stock_out;
                                    $runningBalance += $currentBalance;
                                    $balanceDisplay =  ($runningBalance >= 0 ? ' ' : ' -').abs($runningBalance) ;
