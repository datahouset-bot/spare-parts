...
@endif
    ...
    <div class="card my-1">
        ...
        <h4>Day End Report Date Wise  <h4>       </div>
       <div class="container mt-1" id="account_select_form">
        <form action="{{ url('datewisedayend') }}" method="POST">
            @csrf
            <div class="row">
              <div class="col-md-2 mb-3">
                {{-- <label for="">Selcet User </label>
                <select name="user_id" id="user_id" required>
                  <option value="" disabled selected>Salect User /Staff  Name </option>
...
<script>
  ...
  document.getElementById('from_time').value = `${hours}:${minutes}`;
