...
<body>
    <div class="container-fluid my-1">
        ...
        {{-- <h4>Staff Name - {{$user_name}}&nbsp; From {{\Carbon\Carbon::parse($formatted_from_date)->format('d-m-y')}} To- &nbsp;{{\Carbon\Carbon::parse($formatted_to_date)->format('d-m-y')}}</h4>   --}}
        </div>   
        ...
        <div class="row justify-content-center align-items-center form-group">
            ...
            @foreach ($all_reports as $report)
                <h5>Ledger for Account: {{ $report['account_name'] }} &nbsp;  Date-&nbsp;{{$from_date}} to {{$to_date}}
                </h5>
                        ...
                        <tbody>
                            ...
                            @foreach ($report['ledgers'] as $ledger)
                                <tr>
                                    ...
                                    <td>{{ $ledger->updated_at->format('d-m-y H:i') }}</td> --}}
