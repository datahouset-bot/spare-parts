          ...
          <form action={{url('/amclist_end_month')}} method="POST">
            ...
            <table  id="recordtable" class="table table-striped table-responsive">
                   ...
                   <td scope="col">{{ $diffInDays }}</td>
                        ...
                        <td><a href="{{('itemformview/'.$amc['id']) }}"  class=""><i class="fa fa-eye" style="font-size:20px;color:DarkGreen"></i></a></td>
                        <td><a href="{{('showedititem/'.$amc['id']) }}"  class=""><i class="fa fa-edit" style="font-size:20px;color:SlateBlue"></i></a></td>
                        <td><a href="{{('deleteitem/'.$amc['id']) }}"  class=""><i class="fa fa-trash" style="font-size:20px;color:OrangeRed"></i></a></td>
                      </tr>
                      @endforeach
