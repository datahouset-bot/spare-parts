                                    ...
                                    <div class="card-body">
                                        ...
                                        {{-- <div class="col-md-4 mt-4">
                                          <div class="form-floating mb-3 mb-md-0">
                                            ...
                                            <select name="room_no1" Id ="room_no1"class="form-select" aria-label="Default select example">
                                              <option selected disabled>Select Room No </option>
                                              @foreach ($rooms as $room)
                                                    <option value="{{ $room->id }}">
                                                        {{ $room->room_no }} ||
                                                        {{ $room->roomtype->roomtype_name }} ||
                                                        {{ $room->roomtype->gstmaster->taxname }} ||
                                                        {{ $room->roomtype->package->package_name }} ||
                                                        {{ $room->room_facilities }}||
                                                        {{ $room->roomtype->room_tariff }}
                                              ...
                                              <label for="room_no1">Room No1   </label>
