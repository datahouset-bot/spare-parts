                                            ...
                                            {{-- <div class="col-md-6 mt-1">
                                                <div id="selectedCustomerPic">
                                                    ...
                                                    <img id="guest_pic_response"
                                                        class="mx-1"src="{{ asset('storage\app\public\account_image\\' . ($guest_picresponse ?? 'default.jpg')) }}"
                                                        alt="guest_pic" width="130px">

                                                    <img id="uploded_id_pic_response1"
                                                        src="{{ asset('storage\app\public\account_image\\' . ($guest_pic_id_response ?? 'default.jpg')) }}"
                                                        alt="Uploaded ID pic" width="130PX">
                                                </div>
                                            </div> --}}
                                        </div>

                                        <form id="saveForm" action="{{url('store_by_guest_booking')}}" method="POST"
                                                ...
                                                <div class="col-md-8">
                                                    <div class="row form-group">
                                                        <div class="col-md-3"><span class="requierdfield">*</span>
                                                            ...
                                                            <input type="hidden" name="firm_id"class=" form-control"
                                                            id="firm_id" class="" value="{{ $firm_id }}" readonly>
                                                        ...
                                                        <div class="col-md-3">
                                                            <label
                                                                for="parking_no">Parking No </label>
                                                        ...
                                                        <div class="col-md-3">
                                                            <label
                                                                for="booking_remark">Booking Remark </label>
                                                            <input class="form-control" id="booking_remark" type="text"
                                                                name="booking_remark" value="{{ old('booking_remark') }}"
                                                                autocomplete="off"  />
                                                            <span class="text-danger">
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <td>
                                                                        <input type="text"
                                                                            ...
                                                                            value="{{ $room->roomtype->room_tariff }}" readonly>
                                                                    </td>
                                                                </tr>
                                                            @endforeach
                                                            ...
                                                            <tr>
                                                                <td>
                                                                    <select name="posting_acc_id[]"
                                                                        ...
                                                                        @foreach ($paymentmodes as $paymentmode)
                                                                            <option value="{{ $paymentmode->id }}" disabled>
                                                                ...
                                                                <td>
                                                                    <input type="text" class="amount_input"
                                                                        name="booking_amount[]" autocomplete="off" readonly>
                                                                </td>
                                                            </tr>
                                                        </tbody>
                                                    </table>
                                                      ...
                                                      <tr>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td><input type="text" name="voucher_payment_ref"
                                                                    class="amount_input" autocomplete="off" readonly></td>
                                                        </tr>
                                                        <tr>
...
<script type="text/javascript">
    $(document).ready(function() {
        ...
        $('#checkout_date, #checkin_date').on('change', function() {
            ...
            // Start AJAX request
            $.ajax({
                url: '/room-status_by_guest', // Adjust URL according to your Laravel routes
                type: 'POST',
                data: data,
                dataType: 'json',
                success: function(response) {
    ...
    $.each(response.rooms, function(index, room) {
        var row = '<tr>' +
            ...
            '</label>' +
            '</td>' +
            '<td><input type="text" id="checkin_room_no" name="checkin_room_no" value="' + room.room_no + '" readonly></td>' +
            '<td><input type="text" id="checkin_roomtype" name="checkin_roomtype" value="' + (room.roomtype ? room.roomtype.roomtype_name : '') + '" readonly></td>' +
            '<td><input type="text" id="checkin_room_tariff" name="checkin_room_tariff"    value="' + (room.roomtype ? room.roomtype.room_tariff : '' ) + '"readonly></td>' +
            '</tr>';
        ...
        $('#room_selection tbody').append(row);
                        ...
                        console.log("Unexpected status:", response.status); // Debug: If status is not 200, log it
                    }
                },
