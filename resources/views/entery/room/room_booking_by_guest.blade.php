                            ...
                            <div class="col-lg-12">
                                <div class="card  mt-1">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <form action="{{url('store_by_guest_booking')}}" method="POST" enctype="multipart/form-data">
                                          @csrf          
                                      ...
                                      <div class="col-md-4" id ="room_selection_box">
                                       <table id="room_selection" class="table table-striped table-responsive">
                                        ...
                                        <tr>                                              
                                            ...
                                            <td>
                                                <input type="text" name="checkin_room_tariff"id="checkin_room_tariff" value="{{ $room->roomtype->room_tariff }}" readonly >
                                            </td>
                                            {{-- <td>
