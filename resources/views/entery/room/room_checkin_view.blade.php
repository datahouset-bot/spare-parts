        ...
        <div class="detail">
            ...
            {{-- <table class="table_detail">
                <thead>
                    ...
                    <tr>
                        <th class="th_detail">Checkin Advance</th>
                        <th class="th_detail">Payment Remark</th>
                ...
                <tbody>
                    <tr>
                        ...
                        <td class="td_detail">{{$roomcheckins->checkin_advance}}</td>
                        <td class="td_detail">{{ $roomcheckins->voucher_payment_remark}}</td>
                        <td class="td_detail">{{$roomcheckins->voucher_payment_ref}}</td>
                        <td class="td_detail">{{$roomcheckins->agent}}</td>
