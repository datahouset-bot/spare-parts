                                                ...
                                                <div id="searchCustomer">
                                                  <form   action="{{url('/show_roombooking')}}" method= "POST" class="form-inline" id ="select_roombooking">
                                                    ...
                                                    <div class="input-group">
                                                      ...
                                                      <select name="roombooking_voucher_no" Id ="roombooking_voucher_no"class="form-select" aria-label="Default select example">
                                        ...
                                        <tr>
                                            <td>
                                                <label class="container_chekbox">
                                                    <input type="checkbox" class="room-checkbox" name="checkin_room_id[]" value="{{ $room->id }}">
                                        ...
                                        <div class="col-md-8">
                                          <div class="row form-group">
                                            ...
                                            <div class="col-md-3">
                                              ...
                                              <input class="form-control" id="guest_pincode" type="text" name="guest_pincode" value="{{ old('guest_countery',$compinfofooter->country ) }}" />
                                              <span class="text-danger"> 
                                                @error('guest_pincode')
                                                {{$message}}
                                            ...
                                            <div class="col-md-3">
                                              ...
                                              <input class="form-control" id="guest_phone" type="text" name="guest_phone" value="{{ old('guest_phone') }}" />
                                              <span class="text-danger"> 
                                                @error('guest_phone')
                                                {{$message}}
        ...
        <table id="room_selection" class="table table-striped table-responsive">
          ...
          <tbody>
            ...
            <tr>
              ...
              <td><input type="text" class="amount_input" id="booking_amount" name="booking_amount"
                 readonly></td>
            </tr>

            <tr>
              <td><select name="amt_posting_acc" id="amt_posting_acc">
              ...
              <td><input type="text" name ="voucher_posting_amt"class="amount_input" placeholder="0"></td>
            </tr>

            <tr>
              <td>Payment Refrance</td>
              <td><input type="text" name="voucher_payment_ref"class="amount_input"></td>
            </tr>
            <tr>
              <td>Payment Remark</td>
              <td><input type="text"  name="voucher_payment_remark" class="amount_input"></td>
            </tr>
        ...
        <table id="room_selection" class="table table-striped table-responsive">
          ...
          <tbody>
            ...
            <tr>
              ...
              <td>
              <input type="text" class="amount_input" id="booking_amount" name="booking_amount">
              </td>
            </tr>
