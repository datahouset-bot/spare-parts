                            ...
                            <div class="col-lg-12">
                                <div class="card  mt-1">
                                    <div class="card-header">
                                        <h5 class="text-center font-weight-light my-1">Modify Room CheckIn </h5>
                                    </div>
                                    <div class="card-body">
                                      ...
                                      <div class="row">
                                        ...
                                        <form action="{{ url('roomcheckin_update') }}" method="POST"
                                                ...
                                                <div class="col-md-8">
                                                    <div class="row form-group">
                                                      <div class="col-md-3">
                                                        ...
                                                        <input type="text" name="check_in_no"class=" form-control"
                                                            id="" class="" value="{{ $romcheckins_first->check_in_no }}" readonly>
                                                        <input type="hidden" name="voucher_no"class=" form-control"
                                                            id="" name="voucher_no" class=""
                                                            value="{{ $romcheckins_first->voucher_no }}" readonly>
                                                    ...
                                                    <div class="col-md-3">
                                                        ...
                                                        <input class="form-control date " id="checkin_date"
                                                            ...
                                                            value="{{ $romcheckins_first->checkin_date }}" />
                                                    ...
                                                    <div class="col-md-3">
                                                        <label for="checkin_time">Check In Time<span
                                                                class="requierdfield">*</span></label>
                                                        <input class="form-control" id="checkin_time1" type="time"
                                                            name="checkin_time" value="{{ $romcheckins_first->checkin_time }}" />
                                                        <span class="text-danger">
                                                            @error('checkin_time')
                                                                {{ $message }}
                                                            @enderror
                                                    ...
                                                    <div class="col-md-3">
                                                        ...
                                                        <input class="form-control" id="commited_days" type="text"
                                                            name="commited_days" value="{{ $romcheckins_first->commited_days }}"
                                                            required />
                                                        <span class="text-danger">
                                                            @error('commited_days')
                                                                {{ $message }}
                                                    ...
                                                    <div class="col-md-3">
                                                        ...
                                                        <input class="form-control" id="no_of_guest" type="text"
                                                            name="no_of_guest" value="{{ $romcheckins_first->no_of_guest }}"
                                                            required />
                                                        <span class="text-danger">
                                                            @error('no_of_guest')
                                                                {{ $message }}
                                                    ...
                                                    <div class="col-md-3">
                                                        ...
                                                        <select name="business_source_id" id="business_source_id" class="form-select" aria-label="Default select example">
                                                            <option disabled {{ $romcheckins_first->business_source_id ? '' : 'selected' }}>
                                                                Select Business Source
                                                            </option>
                                                            @foreach ($businesssource as $source)
                                                                <option value="{{ $source->id }}" {{  $romcheckins_first->business_source_id == $source->id ? 'selected' : '' }}>
                                                    ...
                                                    <div class="col-md-6">
                                                        ...
                                                        <select name="package_id" id="package_id" class="form-select" aria-label="Default select example">
                                                            <option disabled {{ old('package_id', $romcheckins_first->package_id) ? '' : 'selected' }}>
                                                                Select Package
                                                            </option>
                                                            @foreach ($package as $item)
                                                                <option value="{{ $item->id }}" {{ old('package_id', $romcheckins_first->package_id) == $item->id ? 'selected' : '' }}>
                                                                    {{ $item->package_name }} || {{ $item->plan_name }}
                                                                </option>
                                                            @endforeach
                                                        </select>
                                                    ...
                                                    <div class="col-md-4">
                                                        ...
                                                        <input class="form-control" id="checkin_remark1"
                                                            type="text" name="checkin_remark1" value="{{$romcheckins_first->checkin_remark1}}" />
                                                        <span class="text-danger">
                                                    ...
                                                    <div class="col-md-8 mb-1">
                                                        ...
                                                        <input class="form-control" id="checkin_remark2"
                                                            type="text" name="checkin_remark2" value="{{$romcheckins_first->checkin_remark2}}" />
                                                        <span class="text-danger">
                                                ...
                                                <div class="col-md-4" id ="room_selection_box">
                                                  <table id="room_selection"
                                                      ...
                                                      <tbody>
                                                        ...
                                                        @php
                                                        // Extract room numbers from $roomCheckins for easy lookup
                                                        $checkinRoomNumbers = $roomCheckins->pluck('room_no')->toArray();
                                                    @endphp
                                                    ...
                                                    @foreach ($rooms as $room)
                                                        <tr>
                                                            <td>
                                                                <label class="container_chekbox">
                                                                    <input type="checkbox" 
                                                                        ...
                                                                        value="{{ $room->id }}" 
                                                                        {{ in_array($room->room_no, $checkinRoomNumbers) ? 'checked' : '' }}>
                                                            ...
                                                            {{-- Uncomment this section if you need the room tariff --}}
                                                            {{-- <td>
                                                    ...
                                                    @endforeach
                                                          ...
                                                          {{-- @foreach ($rooms as $room)
                                                              <tr>
                                                                  <td>
                                                                      <label class="container_chekbox">
                                                                          <input type="checkbox" checked="checked" class="room-checkbox"
                                                                              name="checkin_room_id[]"
                                                                              value="{{ $room->id }}">
                                                                          <span class="checkmark"></span>
                                                                      </label>
                                                    ...
                                                    <div class="row form-group">
                                                        <div class="col-md-6"><span class="requierdfield">*</span>
                                                            ...
                                                            <input class="form-control" id="guest_name" type="text"
                                                                name="guest_name" value="{{$romcheckins_first->guest_name}}"
                                                                autocomplete="none" />
                                                            <span class="text-danger">
                                                                @error('guest_name')
                                                                    {{ $message }}
                                                        ...
                                                        <div class="col-md-3">
                                                            ...
                                                            <input class="form-control" id="guest_address" type="text"
                                                                name="guest_address"
                                                                value="{{$romcheckins_first->account->address}}" />
                                                            <span class="text-danger">
                                                                @error('guest_address')
                                                                    {{ $message }}
                                                                @enderror
                                                        ...
                                                        <div class="col-md-3">
                                                            ...
                                                            <input class="form-control" id="guest_address2"
                                                                ...
                                                                value="{{$romcheckins_first->account->address2}}" />
                                                            <span class="text-danger">
                                                        ...
                                                        <div class="col-md-3">
                                                            ...
                                                            <input class="form-control" id="guest_city" type="text"
                                                                name="guest_city" value="{{$romcheckins_first->account->city}}" />
                                                            <span class="text-danger">
                                                                @error('guest_city')
                                                                    {{ $message }}
                                                                @enderror
                                                        ...
                                                        <div class="col-md-3">
                                                            ...
                                                            <input class="form-control" id="guest_state" type="text"
                                                                name="guest_state" value="{{$romcheckins_first->account->state}}">
                                                            <span class="text-danger">
                                                                @error('guest_state')
                                                                    {{ $message }}
                                                                @enderror
                                                        ...
                                                        <div class="col-md-3">
                                                            ...
                                                            <input class="form-control" id="guest_pincode" type="text"
                                                                name="guest_pincode" value="{{$romcheckins_first->account->pincode}}" />
                                                            <span class="text-danger">
                                                                @error('guest_pincode')
                                                                    {{ $message }}
                                                                @enderror
                                                        ...
                                                        <div class="col-md-3">
                                                            ...
                                                            <input class="form-control" id="guest_nationality"
                                                                ...
                                                                value="{{$romcheckins_first->account->nationality}}" />
                                                            <span class="text-danger">
                                                        ...
                                                        <div class="col-md-3">
                                                            ...
                                                            <input class="form-control" id="guest_phone" type="text"
                                                                name="guest_phone" value="{{$romcheckins_first->account->phone }}"
                                                                autocomplete="none" />
                                                            <span class="text-danger">
                                                                @error('guest_phone')
                                                                    {{ $message }}
                                                        ...
                                                        <div class="col-md-3">
                                                            ...
                                                            <input class="form-control" id="guest_email" type="text"
                                                                name="guest_email" value="{{$romcheckins_first->account->email }}" />
                                                            <span class="text-danger">
                                                                @error('guest_email')
                                                                    {{ $message }}
                                                                @enderror
                                                        ...
                                                        <div class="col-md-3">
                                                            ...
                                                            <input class="form-control" id="guest_idproof_no"
                                                                ...
                                                                value="{{ $romcheckins_first->account->account_idproof_no }}" />
                                                            <span class="text-danger">
                                                        ...
                                                        <div class="col-md-3">
                                                            ...
                                                            <input class="form-control" id="firm_name" type="text"
                                                                name="firm_name" value="{{ $romcheckins_first->account->account_af1}}" />
                                                            <span class="text-danger">
                                                                @error('firm_name')
                                                                    {{ $message }}
                                                                @enderror
                                                        ...
                                                        <div class="col-md-3">
                                                            ...
                                                            <input class="form-control" id="firm_address" type="text"
                                                                name="firm_address" value="{{ $romcheckins_first->account->account_af2 }}" />
                                                            <span class="text-danger">
                                                                @error('firm_address')
                                                                    {{ $message }}
                                                                @enderror
                                                        ...
                                                        <div class="col-md-3">
                                                            ...
                                                            <input class="form-control" id="gst_no" type="text"
                                                                name="gst_no" value="{{ $romcheckins_first->account->gst_no }}" />
                                                            <span class="text-danger">
                                                                @error('gst_no')
                                                                    {{ $message }}
                                                                @enderror
                                                        ...
                                                        <tbody id="payment_mode_body">
                                                            <tr>
                                                                ...
                                                                <td><input type="text" id="room_tariff_perday"
                                                                        ...
                                                                        value="{{$romcheckins_first->room_tariff_perday}}"
                                                                        ></td>
                                                            </tr>
                                                            <tr>
                                                                <td>
                                                      ...
                                                      <tr>
                                                        <td>
                                                          ...
                                                          class="btn  btn-sm btn-primary">+ Payment Mode</button>
                                                            ...
                                                            <td><input type="text" id="total_receipt_amt" name="total_receipt_amt" class="amount_input" readonly></td>
                                                        </tr>
                                                        <tr>
  ...
  --}}
    ...
    <script>
        $(document).ready(function() {
            //disable room tarif dont calculate
