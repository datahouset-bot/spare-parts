...
{{-- 
                                        ...
                                        <form action="{{ route('roombookings.update', $new_voucher_no) }}" method="POST"
                                                ...
                                                <div class="col-md-8">
                                                    ...
                                                    <div class="col-md-3"><span class="requierdfield">*</span>
                                                        ...
                                                        <input class="form-control " id="checkin_date"
                                                            ...
                                                            value="{{ \Carbon\Carbon::parse($roombookings_first->checkin_date)->format('d-m-Y') }}" />
                                                        <span class="text-danger">
                                                            @error('checkin_date')
                                                                {{ $message }}
                                                            @enderror
                                                    ...
                                                    <div class="col-md-3"><span class="requierdfield">*</span>
                                                        ...
                                                        <input class="form-control" id="checkin_time" type="text    "
                                                            name="checkin_time" value="{{ $roombookings_first->checkin_time}}" />
                                                        <span class="text-danger">
                                                            @error('checkin_time')
                                                                {{ $message }}
                                                            @enderror
                                                    ...
                                                    <div class="col-md-3"><span class="requierdfield">*</span>
                                                        ...
                                                        <input class="form-control " id="checkout_date"
                                                            ...
                                                            value="{{ \Carbon\Carbon::parse($roombookings_first->checkout_date)->format('d-m-Y') }}" />
                                                        <span class="text-danger">
                                                            @error('checkout_date')
                                                                {{ $message }}
                                                            @enderror
                                                    ...
                                                    <div class="col-md-3">
                                                        ...
                                                        <input class="form-control" id="commited_days" type="text"
                                                            name="commited_days" value="{{$roombookings_first->commited_days}}"
                                                    ...
                                                    <div class="col-md-3"><span class="requierdfield">*</span>
                                                        ...
                                                        <div class="col-md-3">
                                                            ...
                                                            <select name="business_source_id" id="business_source_id"
                                                                ...
                                                                <option disabled
                                                                    {{ $roombookings_first->business_source_id ? '' : 'selected' }}>
                                                                    Select Business Source
                                                                </option>
                                                                @foreach ($businesssource as $source)
                                                                    <option value="{{ $source->id }}"
                                                                        {{ $roombookings_first->business_source_id == $source->id ? 'selected' : '' }}>
                                                        ...
                                                        <div class="col-md-6">
                                                            ...
                                                            <select name="package_id" id="package_id" class="form-select"
                                                                aria-label="Default select example">
                                                                <option disabled
                                                                    {{ old('package_id', $roombookings_first->package_id) ? '' : 'selected' }}>
                                                                    Select Package
                                                                </option>
                                                                @foreach ($package as $item)
                                                                    <option value="{{ $item->id }}"
                                                                        {{ old('package_id', $roombookings_first->package_id) == $item->id ? 'selected' : '' }}>
                                                                        {{ $item->package_name }} ||
                                                                        {{ $item->plan_name }}
                                                                    </option>
                                                                @endforeach
                                                                    ...
                                                                    <td>
                                                                        <label class="container_chekbox">
                                                                            <input type="checkbox" class="room-checkbox"
                                                                                ...
                                                                                value="{{ $room->id }}"
                                                                                {{ in_array($room->room_no, $bookingRoomNumbers) ? 'checked' : '' }}>
                                                    ...
                                                    <div class="row form-group">
                                                        ...
                                                        <div class="col-md-3">
                                                            ...
                                                            <input class="form-control" id="guest_city" type="text"
                                                                name="guest_city"
                                                                value="{{ $roombookings_first->guest_city }}" />
                                                            <span class="text-danger">
                                                                @error('guest_city')
                                                                    {{ $message }}
                                                                @enderror
                                                        ...
                                                        <div class="col-md-3">
                                                            ...
                                                            <input class="form-control" id="guest_state" type="text"
                                                                name="guest_state"
                                                                value="{{ $roombookings_first->guest_state }}">
                                                            <span class="text-danger">
                                                                @error('guest_state')
                                                                    {{ $message }}
                                                                @enderror
                                                        ...
                                                        <div class="col-md-3">
                                                            ...
                                                            <input class="form-control" id="guest_pincode" type="text"
                                                                name="guest_pincode"
                                                                value="{{ $roombookings_first->guest_pincode }}" />
                                                            <span class="text-danger">
                                                                @error('guest_pincode')
                                                                    {{ $message }}
                                                                @enderror
                                                        ...
                                                        <div class="col-md-3">
                                                            ...
                                                            <input class="form-control" id="guest_nationality"
                                                                ...
                                                                value="{{ $roombookings_first->guest_nationality }}" />
                                                            <span class="text-danger">
                                                        ...
                                                        <div class="col-md-3"><span class="requierdfield">*</span>
                                                            ...
                                                            <input class="form-control" id="guest_mobile" type="text"
                                                                name="guest_mobile"
                                                                value="{{ $roombookings_first->guest_mobile }}"
                                                                autocomplete="none" />
                                                            <span class="text-danger">
                                                                @error('guest_mobile')
                                                                    {{ $message }}
                                                        ...
                                                        <div class="col-md-3">
                                                            ...
                                                            <input class="form-control" id="guest_phone" type="text"
                                                                name="guest_phone"
                                                                value="{{ $roombookings_first->guest_phone }}"
                                                                autocomplete="none" />
                                                            <span class="text-danger">
                                                                @error('guest_phone')
                                                                    {{ $message }}
                                                        ...
                                                        <div class="col-md-3">
                                                            ...
                                                            <input class="form-control" id="guest_email" type="text"
                                                                name="guest_email"
                                                                value="{{ $roombookings_first->guest_email }}" />
                                                            <span class="text-danger">
                                                                @error('guest_email')
                                                                    {{ $message }}
                                                                @enderror
                                                        ...
                                                        <div class="col-md-3">
                                                            ...
                                                            <input class="form-control" id="guest_idproof_no"
                                                                ...
                                                                value="{{ $roombookings_first->guest_idproof_no }}" />
                                                            <span class="text-danger">
                                                        ...
                                                        <div class="col-md-3">
                                                            ...
                                                            <input class="form-control" id="firm_name" type="text"
                                                                name="firm_name"
                                                                value="{{ $roombookings_first->firm_name }}" />
                                                            <span class="text-danger">
                                                                @error('firm_name')
                                                                    {{ $message }}
                                                                @enderror
                                                        ...
                                                        <div class="col-md-3">
                                                            ...
                                                            <input class="form-control" id="firm_address" type="text"
                                                                name="firm_address"
                                                                value="{{ $roombookings_first->firm_address }}" />
                                                            <span class="text-danger">
                                                                @error('firm_address')
                                                                    {{ $message }}
                                                                @enderror
                                          ...
                                          <table id="room_selection" class="table table-striped table-responsive">
                                            ...
                                            <tbody>
                                              ...
                                              <tr>
                                                ...
                                                <div class="col-md-4" id="payment_selection_box">
                                                    <h5>Payment Detail **Adv Amt  {{$final_opning_balance}} </h5> 
                                                    <table id="room_selection"
                                                        class="table table-striped table-responsive">
                                                        <thead>
                                                            <tr>
                                                        ...
                                                        <tbody id="payment_mode_body">
                                                            <tr>
                                                                ...
                                                                <td><input type="text" id="room_tariff_perday"
                                                                        ...
                                                                        value="{{ $roombookings_first->room_tariff_perday }}">
                                                                </td>
                                                            </tr>
                                                            <tr>
                                                                <td>
