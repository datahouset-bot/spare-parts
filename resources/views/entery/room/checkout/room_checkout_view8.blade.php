...
.qr_code p {
    ...
    <body>
        ...
        <div class="page">
                ...
                <div class="bill_head">  FOOD TAX INVOICE</div>
                <div class="billtype">
            ...
            <div class="company_info">
                ...
                <div class="firm_detail">
                    ...
                    <span class="firm_address1">{{ $componyinfo->cominfo_address1 }}&nbsp;{{ $componyinfo->cominfo_address2 }}&nbsp;{{ $componyinfo->cominfo_city }}&nbsp;{{ $componyinfo->cominfo_state }}</span>
                    <span class="firm_address1">{{ $componyinfo->cominfo_pincode }}&nbsp;{{ $compinfofooter->country }}</span>

                </div>
                <div class="logo2"><img src="{{ asset('storage\app\public\image\\' . $pic->brand) }}" alt="qr_code"
                        width="80px"></div>
            </div>
            <div class="firm_conatct">
                Email:{{ $componyinfo->cominfo_email }} Phone &nbsp;{{ $componyinfo->cominfo_phone }}
                    Mobile&nbsp;{{ $componyinfo->cominfo_mobile }} website&nbsp;{{ $componyinfo->cominfo_field2 }}

            </div>
            
            <div class="invno_and_date">
                    <div>Invoice No:{{ $roomcheckouts->check_out_no }}-A</div>
                ...
                <table class="table_detail">
                    <thead>
                        ...
                        <tr>
                            ...
                            <th class="th_detail">Food Bill No  </th>
                            <th class="th_detail">Food Bill Date</th>
                            <th class="th_detail">FoodBill Kot </th>
                    ...
                    <tbody>
                        ...
                        @foreach ($foodbills as $record)
                         <tr>
                            <td class="item_record">{{$r+=1}}</td>
                            <td class="item_record">{{$record->food_bill_no}}</td>
                            <td class="item_record">{{ $record->voucher_date }}</td>
                                  <td class="item_record">{{ $record->kot_no }}</td>
                            <td class="item_record">{{ $record->total_bill_value }}</td>
