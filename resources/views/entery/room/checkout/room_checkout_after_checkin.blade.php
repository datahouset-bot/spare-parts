...
@section('pagecontent')
                    ...
                    <div class="container">
                                                    ...
                                                    <div class="row form-group">
                                                      ...
                                                      {{-- kot Box  --}}
                                                        <div class="col-md-4 my-1 " id ="foodkot_selection_box">
                                                            ...
                                                            <table id="foodkot_table" class="table table-striped table-responsive">
                                                                <thead>
                                                                    <tr>
                     ...
                     $total_amount_kot=0; 
                      @endphp --}}
                                                        ...
                                                        <input type="text" class="input_id" id ="total_food_bill_amount"
                                                   ...
                                                   <div class="col-md-4 my-1 " id ="foodkot_selection_box">
                                                    ...
                                                    <table id="rent_diplay" class="table table-striped table-responsive">
                                                        <thead>
                                                            <tr>
                                                                <th># </th>
                                                                <th>Start Date </th>
                                                ...
                                                <div class="col-md-4" id ="paymnet_selection_box">
                                                    ...
                                                    <table id="payment_table"
                                                        ...
                                                        <tbody>
                                                            ...
                                                            <td><input type="text" name ="amt_post_credit_amt"
                                                                    id="amt_post_credit_amt" class="amount_input "
  ...
  --}}
        ...
        {{-- Ajex for room Rent recalculate Calculation on click recalculate   --}}
        {{-- <script type="text/javascript">
            $(document).ready(function() {
                $('#recalculate').on('click', function(e) {
                    ...
                    $.ajax({
                        ...
                        success: function(response) {
                            ...
                            var total_advance = parseFloat($('#total_advance').val()) || 0;
                            var final_room_rent = parseFloat($('#final_room_rent').val()) || 0;
                            var voucher_posting_amt = parseFloat($('#voucher_posting_amt').val()) ||
                                0;
                            var amt_post_credit_amt = parseFloat($('#amt_post_credit_amt').val()) ||
                                0;

                            var gst_total = (gst_percent * final_room_rent) / 100;
                            $('#gst_total').val(gst_total);
                            var bill_amount = final_room_rent + total_food_amt + gst_total +
                                add_other - less_discount;
                            $('#bill_amount').val(bill_amount);


                            // var balance_to_pay = final_room_rent + total_advance + total_food_amt +
                            //     gst_total - less_discount;
                            var balance_to_pay = bill_amount+ total_advance;
                            $('#balance_to_pay').val(balance_to_pay);

                            var balance_amt = balance_to_pay - voucher_posting_amt -
                                amt_post_credit_amt;
        ...
        <script type="text/javascript">
            $(document).ready(function() {
                function recalculate() {
                    ...
                    $.ajax({
                        ...
                        success: function(response) {
                            ...
                            var total_advance = parseFloat($('#total_advance').val()) || 0;
                            var final_room_rent = parseFloat($('#final_room_rent').val()) || 0;
                            var voucher_posting_amt = parseFloat($('#voucher_posting_amt').val()) || 0;
                            ...
                            var balance_amt = balance_to_pay - voucher_posting_amt - amt_post_credit_amt;
                            $('#balance_amt').val(balance_amt);
                ...
                $('#voucher_posting_amt').on('keyup', function() {
                    recalculate();
                });
