                ...
                <table class="table_detail">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td class="td_detail">{{number_format( ($roomcheckouts->total_food_amt/105)*100 ,2) }}</td>
                        </tr>
                        <tr>
                            <td colspan="3"></td>
                            <td colspan="2"` class="td_total">Food GST 5%</td>
                            <td class="td_detail">{{ number_format($roomcheckouts->total_food_amt - ($roomcheckouts->total_food_amt / 105) * 100, 2) }}
                            </td>
                        </tr>
                        <tr>
                            <td colspan="3"></td>
                ...
                <div class="tax_detail "style="background-color:white">
                    ...
                    <table class="table table-striped tax_summery table-resposive">
                        ...
                        <tbody>
                            ...
                            <tr>
                                <td>996311</td>
                            <td>{{number_format( ($roomcheckouts->total_food_amt/105)*100,2)  }}</td>
                            <td>5.00    </td>
                            <td>{{ number_format(($roomcheckouts->total_food_amt-($roomcheckouts->total_food_amt/105)*100 )/2,2) }}</td>
                            <td>{{number_format(($roomcheckouts->total_food_amt-($roomcheckouts->total_food_amt/105)*100 )/2 ,2)}}</td>
                            <td>{{$roomcheckouts->igst}}</td>
                            <td>{{number_format(($roomcheckouts->total_food_amt-($roomcheckouts->total_food_amt/105)*100 ),2)}}</td>
                            </tr>
