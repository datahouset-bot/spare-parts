...
.qr_code p {
    ...
    right: 120; /* Align the text to the right */
        ...
        <div class="page">
            ...
            <div class="company_info">
                <div class="logo1">&nbsp;<img src="{{ asset('storage\app\public\image\\' . $pic->logo) }}" alt="qr_code"
                        width="180px">
                        <br><span class="font8">Email:{{ $componyinfo->cominfo_email }}</span></div>
            ...
            <div class="voucher_footer">
                <div class="tax_detail "style="background-color:white">
                    ...
                    <table class="table table-striped tax_summery">
                        <thead>
                            <tr>
                                <th>SAC Code</th>
