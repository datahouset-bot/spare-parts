            ...
            <div class="page_header">
                <div class="info-container">
                    <div class="cust_info">
                       ...
                       <span>Name:{{ $advancereceipts->account_name }}</span><br>
                       <span>Mobile No:{{ $advancereceipts->guest_mobile }}</span><br>
                       <span>Remark:{{ $advancereceipts->remark }}</span><br>
                    </div>
                    <div class="voucher_info">

                        <span>Receipt No : {{ $advancereceipts->reciept_no }}</span><br>
                        <span>Date : {{ $advancereceipts->entry_date }}</span><br>
                        <span>Time : {{ $advancereceipts->created_at->format('H:i') }}</span><br>
                    </div>
                </div>
            ...
            <div class="detail">
                ...
                <table class="table_detail">
                    <thead>
                        ...
                        <tr>
                            <th class="th_detail">Amount  :: {{ $advancereceipts->amount }}</th>
                        </tr>
                    </thead>
                    <tbody>
