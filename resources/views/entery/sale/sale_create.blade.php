...
@section('pagecontent')
    ...
    <div class="container-fluid ">
            ...
            <div class="card-header d-flex justify-content-between align-items-center position-relative">
                ...
                <div class="d-flex gap-2">
                    <div class="position-relative">
                        ...
                        <button type="button" class="btn btn-outline-secondary btn-sm" id="toggleSettings">
                            <i class="fa fa-cog"></i>
                        </button>
                    ...
                    <a href="{{ route('sales.index') }}" class="btn btn-outline-secondary btn-sm" title="shortcut:ctrl+b">
                        <i class="fa fa-arrow-left"></i> Back
                    </a>


                    <a href="{{ url('temp_item_delete/' . Auth::user()->id) }}" class="btn btn-success btn-sm">
                        Add New
                    </a>

                    <a href="{{ url('store_to_sale/' . Auth::user()->id) }}" class="btn btn-primary btn-sm">
                        Save
                    </a>
                </div>

                <div id="settingsPopup" class="settings-popup shadow-sm">
            ...
            <div class="row my-2">
                ...
                <form id="item_entry">
                    <div class="row no-gutter" name="kot_header">
                        ...
                        <div class="col-md-1 col-4 text-center ">
                            <div class="form-group">
                                <input type="text" id="purchase_bill_date" class="form-control date"
                                    name="purchase_bill_date" required>
                    ...
                    <div class="row no-gutter" name="itementery">
                        ...
                        <div class="col-md-3   ">
                            <div class="d-flex align-items-center gap-1">
                                ...
                                <a href="{{ url('/item') }}" class="btn btn-outline-primary btn-plus"
                                    title="Add Batch">
                                    <i class="fa fa-plus"></i>
                                </a>
                        ...
                        <div class="col-md-2 col-3 text-center">
                            <div class="form-group">
                                ...
                                <span id="display_rate"
                                    style="position: absolute; right: 5px; top: -10px; font-size: 12px; color: #666;"></span>
                            </div>
                        </div>
                        ...
                        <div class="col-md-2 col-3 col-sm-2text-center">
                            <div class="form-group">
                                <input type="text" class="form-control" id="total_item_dis_amt"
                                    name="total_item_dis_amt" placeholder=" ">
                        ...
                        <div class="col-md-1 col-3 col-sm-2 text-center">
                            <div class="form-group">
                                <input type="text" class="form-control" id="gst_p" name="gst_p"
                                    placeholder=" " required readonly>
                        ...
                        <div class="col-md-2 col-3 text-center">
                            <div class="form-group">
                                <input type="text" class="form-control" id="gst_amt" name="gst_amt"
                                    placeholder=" " required readonly>
                        ...
                        <div class="col-md-2 col-3 text-center">
                            <div class="form-group">
                                <input type="text" class="form-control" id="net_item_amt" name="net_item_amt"
                                    placeholder=" " required readonly>
                ...
                <div class="row  mx-2 table-scrollable">
                    <table id ="sold_item_record"class="table table-striped  table-responsive ">
                        ...
                        <tfoot class="table-dark">
                            <tr>
                                <td>Total </td>
                                <td><input type="text" class="footer_input" name="total_records" id="total_records">
                                </td>
                                ...
                                <td id=""></td>
                                <td><input type="text" class="footer_input"name="total_bill_gst" id="total_bill_gst">
                                </td>
                                <td><input type="text" class="footer_input"name="total_bill_net" id="total_bill_net">
                                </td>
                                <td></td>
                                <td></td>
                            </tr>
                                    ...
                                    <div class="modal-content">
                                        ...
                                        <form id="unitForm">
                                            ...
                                            <div class="modal-body">
                                                ...
                                                <input type="text" name="primary_unit_name" class="form-control"
                                                    required>

                                                <label class="mt-2">Conversion</label>
                                                <input type="number" step="0.0001" name="conversion"
                        ...
                        success: function(response) {
                            ...
                            if (response.batch_info && response.batch_info.length > 0) {
                                ...
                                response.batch_info.forEach(function(batch) {
                                    options +=
                                        `<option value="${batch.id}"><td>${batch.batch_no}</td> (${batch.batch_af1} (${batch.batch_mrp}) (${batch.batch_sale_rate} )</option>`;
                                });

                                $('#batch_id').html(
                                    options); // Assuming you have a <select id="batch_select">
                    ...
                    $.ajax({
                        ...
                        success: function(response) {
                            ...
                            if (response.searched_batch_info) {
                                ...
                                $('#display_rate').text(response.searched_batch_info
                                    .batch_sale_rate);
        ...
        <script></script>
        {{-- ===================================================extra ajax  for acount item and other changes====================================================================== --}}
