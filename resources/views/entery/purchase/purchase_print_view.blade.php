...
{{-- 
                    ...
                    <div class="voucher_info">
                        ...
                        <span>Invoice No : {{ $voucher_header->voucher_bill_no }}</span><br>
                ...
                <table class="table_detail">
                    ...
                    <tbody>
                        ...
                        <tr>
                          ...
                          <td>{{ number_format(($records->qty*$records->rate)+$records->gst_item_amount,1)}}</td>  
            ...
            <div class="page_header">
                <div class="info-container">
                    <div class="cust_info">
                        ...
                        <span>Total Qty ={{$voucher_header->total_qty}}</span><br>
                    ...
                    <div class="voucher_info">
                        <table id="footer_total">
                            <tr>
                                <td>Basic Amt:</td>
                                <td>{{ $voucher_header->total_item_basic_amount }}</td>
                            </tr>
                            <tr>
                                <td>Dis {{ $voucher_header->disc_percent}}% :</td>
                                <td>{{ $voucher_header->total_disc_item_amount }}</td>
                            </tr>

                            <tr>
                                <td>SGST Amt:</td>
                                <td>{{ $voucher_header->total_gst_amount/2  }}</td>
                            </tr>
                            <tr>
                                <td>CGST Amt:</td>
                                <td>{{ $voucher_header->total_gst_amount/2}}</td>
                            ...
                            <tr>
                                <td>Round Off:</td>
                                <td>{{ $voucher_header->total_roundoff}}</td>
                            </tr>
                            <tr>
                                <td>Grand Total :</td>
                                <td><h3>{{ $voucher_header->total_net_amount}}</h3></td>
                            </tr>
                        </table>
