...
<body>
                    ...
                    <div class="row">
                        <div class="col-6">
                            <table style="width:100%">
                                ...
                                <tr>
                                    <td class="voucher_head">{{ $compinfofooter->ct2 }}Start Date  </td>

                                <tr>
                                <tr>
                                    <td class="voucher_head_detail">{{ \Carbon\Carbon::parse($amc['amc_start_date'])->format('d-m-y')}}</td>
                                </tr>
                                <tr>
                                    <td class="voucher_head">{{ $compinfofooter->ct2 }}End Date</td>

                                <tr>
                                <tr>
                                    <td class="voucher_head_detail">{{ \Carbon\Carbon::parse($amc['amc_end_date'])->format('d-m-y') }}</td>
                                </tr>
                                <tr>
                                    <td class="voucher_head">{{ $compinfofooter->ct2 }}Amount </td>
                                ...
                                <tr>
                                    <td class="voucher_head">{{ $compinfofooter->ct2 }} Status</td>
    ...
    <div class="col-6">
        <table style="width:100%">
            ...
            <tr>
                <td class="voucher_head">Company: {{ $amc->item->comp_name }}</td>
            ...
            <tr>
                <td class="voucher_head">Unit: {{ $amc->item->unit->primary_unit_name }}</td>
