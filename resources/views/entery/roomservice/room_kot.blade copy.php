        ...
        <form id="item_entry">
            <div class="row my-2" name="kot_header">
                ...
                <div class="col-md-2 col-4  text-center">
                    ...
                    <input type="text" class="form-control" id="voucher_no" name="voucher_no" value={{ $new_voucher_no
                        }}>
                </div>
                <div class="col-md-2 col-4  text-center">
                ...
                <div class="modal-dialog" role="document">
                    <div class="modal-content">
                        <div class="modal-header">
                            <h5 class="modal-title" id="exampleModalLabel">Add KOT</h5>
                        ...
                        <div class="modal-body">
                            <form action="{{url('/reciept_store')}}" method="POST">
                                ...
                                <div class="col-md-12">
                                    ...
                                    <input type="text" value="" class="form-control" name="transaction_type" readonly>
                                </div>

                                <div class="col-md-12">
                                    <label for="reciept_no">Reciept No </label>
                                    <input type="text" value="" class="form-control" name="reciept_no">
                                </div>
                                <div class="col-md-12">
                                    <label for="voucher_number">Voucher No </label>
                                    <input type="text" value="" class="form-control" name="voucher_no">
                                </div>

                                <div class="col-md-12">
                                    <label for="voucher_date">Date </label>
                                    <input type="text" class="form-control date" name="voucher_date">

                                </div>
                                <div class="col-md-12">
                                    <label for="payment_mode_id">Payment Mode </label>
                                    <select id="" name="payment_mode_id" class="form-control myitemgroup form-select">
                                ...
                                <div class="col-md-12">
                                    ...
                                    <select id="" name="account_id" class="form-control myitemgroup form-select">
