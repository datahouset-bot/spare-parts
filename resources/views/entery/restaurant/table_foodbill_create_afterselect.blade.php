        ...
        <div class="card my-3">
            ...
            <div class="row my-2">
                <div class="col-md-12 text-center">
                    ...
                    <form action="{{ url('table_foodbills_store') }}" method="POST" style="display:inline;">
                        @csrf
            ...
            <form id="item_entry">
                <div class="row my-2 mx-1" name="kot_header">
                    ...
                    <div class="col-md-2 col-4  text-center">
                        ...
                        <input type="text" class="form-control" id="voucher_type" name="voucher_type" value="Restaurant_food_bill">
                    </div>
                    <div class="col-md-2 col-4  text-center">
            ...
            <div class="row my-2" name="kot_header">
                ...
                <div class="col-md-2 col-4 text-center ">
                    ...
                    <select name="posting_acc_id" id="posting_acc_id" class="form-select">
                        <option value="" >Settel To Room </option>
                        @foreach ($paymentmodes as $paymentmode)
                            <option value="{{ $paymentmode->id }}" selected>{{ $paymentmode->account_name }}
                            </option>
                        @endforeach
