        ...
        <div class="card my-3">
            ...
            <div class="row my-2">
                <div class="col-md-12 text-center">
                    ...
                    <a href="{{ url('kot_update/' . Auth::user()->id) }}" class="btn btn-primary">Save</a>
                    <a href="{{ url('kot_update_print/' . Auth::user()->id) . '/' . $new_voucher_no }}"
                ...
                <div class="row my-2" name="kot_header">
                    ...
                    <div class="col-md-2 col-4  text-center">
                        ...
                        <select name="service_id" id="service_id" class="form-select">
                            <option  value="{{$service_id}}" >{{$checkinlists->guest_name}}|| {{$checkinlists->room_nos}} </option>
