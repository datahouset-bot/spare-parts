        ...
        <div class="page">
            ...
            <div class="page_header">
                <div class="info-container">
                    <div class="cust_info">
                       @if(isset($inputbagdata['customer_name']))
                        <span>Guest Name: {{$inputbagdata['customer_name'] }}</span><br>
                    @else
                        <span>Guest Name:</span><br>
                    @endif
                     
                    @if(isset($inputbagdata['address']))
                        <span>Adress: {{ $inputbagdata['address'] }}</span><br>
                    @else
                        <span>Address:</span><br>
                    @endif
                    
                    @if(isset($inputbagdata['mobile']))
                        <span>Mobile: {{ $inputbagdata['mobile'] }}</span><br>
                    @else
                        <span>Mobile: </span><br>
                    @endif
                ...
                @endif
                    ...
                    <div class="voucher_info">
                        ...
                        <span>Date : {{ $inputbagdata['voucher_date'] }}</span><br>
                         ...
                         <span>Table No :&nbsp;{{$table->table_name}} </span>
