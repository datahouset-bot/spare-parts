                        ...
                        <div class="row justify-content-center">
                            ...
                            <input type="date" name ="to_date"  value="{{  date('Y-m-d') }}"class="">  --}}
                                                      ...
                                                      <span class="text-danger"> 
                                                        ...
                                                        <label for="amc_start_date">{{ $compinfofooter->ct2 }} Start Date </label>
                                                ...
                                                <div class="col-md-4 mt-2">
                                                  <div class="form-floating mb-3 mb-md-0">
                                                    ...
                                                    <span class="text-danger"> 
                                                      ...
                                                      <label for="account_group">{{ $compinfofooter->ct2 }} End Date </label>
                                              ...
                                              <div class="col-md-4 mt-2">
                                                <div class="form-floating mb-3 mb-md-0">
                                                  ...
                                                  <span class="text-danger"> 
                                                    ...
                                                    <label for="amc_amount">{{ $compinfofooter->ct2 }} Amount </label>
                                              ...
                                              <div class="col-md-4 mt-2">
                                                <div class="form-floating mb-3 mb-md-0">
                                                  ...
                                                  <select name="amc_status" Id ="amc_status"class="form-select" aria-label="Default select example">
                                                    <option selected disabled>{{ $compinfofooter->ct2 }} Status </option>
                                                    ...
                                                    <label for="amc_status">{{ $compinfofooter->ct2 }} Status   </label>
