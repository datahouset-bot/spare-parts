        ...
        <div class="card my-3 w-100" style="border-radius:5px;">
            ...
            <form id="item_entry">
                <div class="row no-gutter" name="kot_header">
                    ...
                    <input type="hidden" class="form-control" id="voucher_type" name="voucher_type" value="Stock_Transfer">
                    ...
                    <div class="col-md-2 col-4  text-center">
                        <label for="godown_id">From Godown</label>
                    ...
                    <div class="col-md-2 col-4  text-center">
                        <label for="to_godown_id">To Godown</label>

                        <select id ="to_godown_id"name="to_godown_id" class="form-select">
                            @foreach ($godowns as $godown)
                            <option value="{{$godown->id}}" selected>{{$godown->godown_name}}</option>
                            @endforeach
    ...
    <script type="text/javascript">
        $(document).ready(function() {
            ...
            function itementry() {
                ...
                $.ajax({
                    url: '/stocktransfers', // Adjust the URL as per your Laravel routes
                    type: 'POST',
                    data: data,
                    dataType: 'json',
                    headers: {
