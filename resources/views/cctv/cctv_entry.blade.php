                        ...
                        <div class="row justify-content-center">
                            <div class="col-lg-12">
                                <div class="card  mt-1">
                                    ...
                                    <div class="card-body">
                                   <form action="{{url('cctv/store')}}" method="POST">
                                              @csrf
...
<div class="section-heading">
    Customer Service Report
                                        ...
                                        <label for="cust_name">Select Customer Name  </label>
                                          <div class="form-floating mb-3 mb-md-0">

                                             
                                            <select  name ="cust_name" id ="account"class="mycustomer form-select" aria-label="Default select example">
                                          ...
                                          <input class="form-control" id="problem" type="text" name="problem" value="{{ old('problem') }}" />
                                            ...
                                            <div class="col-md-4 mt-4">
                                              <div class="form-floating mb-3 mb-md-0">
                                                ...
                                                <select name="equipment_type" Id ="equipment_type"class="form-select" aria-label="Default select example">
