...
@endif
    ...
    <div class="card-body">
       ...
       required>
                    ...
                    <input type="email" name="email" class="form-control mb-3" placeholder="Email"></div>

                    <div class="mb-2">
                    <small class="text-muted">Mobile no</small>
                    <input type="text" name="mobile" class="form-control mb-3" placeholder="Mobile No"></div>

                    <div class="mb-2">
                    <small class="text-muted">Address</small>
                    <textarea name="address" class="form-control mb-3" rows="2" placeholder="Address"></textarea></div>


                    <div class="mb-2">
                    <small class="text-muted">Document no.</small>
                    <input type="text" name="document_no" class="form-control mb-3" placeholder="Document No"></div>
                ...
                <div class="col-md-6">
                    ...
                    <input type="text" name="designation" class="form-control mb-3" placeholder="Designation"></div>
