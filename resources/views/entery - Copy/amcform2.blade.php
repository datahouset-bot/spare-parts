                        ...
                        <div class="row justify-content-center">
                            <div class="col-lg-12">
                                <div class="card shadow-lg border-0 rounded-lg mt-5">
                                    <div class="card-header"><h3 class="text-center font-weight-light my-4">Amc Entery</h3></div>
                                    <div class="card-body">
                                        <form action="{{url('/amccreat')}}" method="POST">
                                            ...
                                            <div class="row mb-3">
                                                ...
                                                <div class="col-md-4 mt-2">
                                                  <div class="form-floating mb-3 mb-md-0">
                                                      <input class="form-control" id="amc_end_date" type="date" name="amc_end_date" value="{{ date('Y-m-d') }}" />
                                                    <span class="text-danger"> 
                                                      @error('amc_end_date')
                                                      {{$message}}
                                            ...
                                            <div class="col-md-6 mt-2">
                                                <div class="form-floating mb-3 mb-md-0">
                                                    ...
                                                    <input type="hidden" name="account_name" id="account_name"> <!-- Hidden input to store the account name -->
                                                    <span class="text-danger"> 
                                                        @error('cust_name_id')
                                                            {{ $message }}
                                                        @enderror
